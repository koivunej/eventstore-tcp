        ...
        pub mod mod_Messages {
            ...
            impl<'a> MessageWrite for NewEvent<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event_id).len()) + 1 +
                    sizeof_len((&self.event_type).len()) + 1 +
                    sizeof_varint(*(&self.data_content_type) as u64) + 1 +
                    sizeof_varint(*(&self.metadata_content_type) as u64) +
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.metadata {
            ...
            impl<'a> EventRecord<'a> {
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            Ok(10) => {
                                msg.event_stream_id = r.read_string(bytes).map(Cow::Borrowed)?
                            }
            ...
            impl<'a> MessageWrite for EventRecord<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.event_number) as u64) + 1 +
                    sizeof_len((&self.event_id).len()) + 1 +
                    sizeof_len((&self.event_type).len()) + 1 +
                    sizeof_varint(*(&self.data_content_type) as u64) + 1 +
                    sizeof_varint(*(&self.metadata_content_type) as u64) +
                    1 + sizeof_len((&self.data).len()) +
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.metadata {
                        w.write_with_tag(66, |w| w.write_bytes(&**s))?;
                    }
                    if let Some(ref s) = self.created {
                        w.write_with_tag(72, |w| w.write_int64(*s))?;
                    }
                    if let Some(ref s) = self.created_epoch {
                        w.write_with_tag(80, |w| w.write_int64(*s))?;
                    }
                    Ok(())
                }
            }
                ...
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            ...
                            Ok(18) => {
                                msg.link = Some(r.read_message(bytes, EventRecord::from_reader)?)
                            }
                            Ok(t) => {
                                r.read_unknown(bytes, t)?;
                            }
            ...
            impl<'a> MessageWrite for ResolvedIndexedEvent<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event).get_size()) +
            ...
            impl<'a> MessageWrite for ResolvedEvent<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event).get_size()) +
                    self.link.as_ref().map_or(0, |m| 1 + sizeof_len((m).get_size())) +
                    1 + sizeof_varint(*(&self.commit_position) as u64) + 1 +
                    sizeof_varint(*(&self.prepare_position) as u64)
                }
                ...
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            ...
                            Ok(26) => {
                                msg.events.push(r.read_message(bytes, NewEvent::from_reader)?)
                            }
            ...
            impl<'a> MessageWrite for WriteEvents<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.expected_version) as u64) +
            ...
            impl<'a> MessageWrite for DeleteStream<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.expected_version) as u64) + 1 +
                    sizeof_varint(*(&self.require_master) as u64) +
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.hard_delete {
            ...
            impl<'a> MessageWrite for TransactionStartCompleted<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_varint(*(&self.transaction_id) as u64) +
            ...
            impl MessageWrite for TransactionCommit {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_varint(*(&self.transaction_id) as u64) + 1 +
                    sizeof_varint(*(&self.require_master) as u64)
                }
            ...
            impl<'a> MessageWrite for TransactionCommitCompleted<'a> {
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.commit_position {
                        w.write_with_tag(56, |w| w.write_int64(*s))?;
                    }
                    Ok(())
                }
            }
            ...
            impl<'a> MessageWrite for ReadEvent<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.event_number) as u64) + 1 +
                    sizeof_varint(*(&self.resolve_link_tos) as u64) + 1 +
                    sizeof_varint(*(&self.require_master) as u64)
                }
                ...
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            ...
                            Ok(18) => {
                                msg.event =
                                    r.read_message(bytes, ResolvedIndexedEvent::from_reader)?
                            }
            ...
            impl<'a> MessageWrite for ReadEventCompleted<'a> {
                fn get_size(&self) -> usize {
                    0 + self.result.as_ref().map_or(0, |m| 1 + sizeof_varint(*(m) as u64)) + 1 +
                    sizeof_len((&self.event).get_size()) +
            ...
            impl<'a> MessageWrite for ReadStreamEvents<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.from_event_number) as u64) + 1 +
                    sizeof_varint(*(&self.max_count) as u64) + 1 +
                    sizeof_varint(*(&self.resolve_link_tos) as u64) + 1 +
                    sizeof_varint(*(&self.require_master) as u64)
                }
                ...
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            Ok(10) => {
                                msg.events
                                    .push(r.read_message(bytes, ResolvedIndexedEvent::from_reader)?)
                            }
                            Ok(16) => msg.result = Some(r.read_enum(bytes)?),
            ...
            impl<'a> MessageWrite for ReadStreamEventsCompleted<'a> {
                fn get_size(&self) -> usize {
                    0 + self.events.iter().map(|s| 1 + sizeof_len((s).get_size())).sum::<usize>() +
                    self.result.as_ref().map_or(0, |m| 1 + sizeof_varint(*(m) as u64)) +
                    1 + sizeof_varint(*(&self.next_event_number) as u64) + 1 +
                    sizeof_varint(*(&self.last_event_number) as u64) + 1 +
                    sizeof_varint(*(&self.is_end_of_stream) as u64) + 1 +
                    sizeof_varint(*(&self.last_commit_position) as u64) +
                    self.error.as_ref().map_or(0, |m| 1 + sizeof_len((m).len()))
                }
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.error {
                        w.write_with_tag(58, |w| w.write_string(&**s))?;
                    }
                    Ok(())
                }
            }
            ...
            impl MessageWrite for ReadAllEvents {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_varint(*(&self.commit_position) as u64) + 1 +
                    sizeof_varint(*(&self.prepare_position) as u64) + 1 +
                    sizeof_varint(*(&self.max_count) as u64) + 1 +
                    sizeof_varint(*(&self.resolve_link_tos) as u64) + 1 +
                    sizeof_varint(*(&self.require_master) as u64)
                }
                ...
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            ...
                            Ok(16) => msg.prepare_position = r.read_int64(bytes)?,
                            Ok(26) => {
                                msg.events.push(r.read_message(bytes, ResolvedEvent::from_reader)?)
                            }
            ...
            impl<'a> MessageWrite for ReadAllEventsCompleted<'a> {
                fn get_size(&self) -> usize {
                    ...
                    self.events.iter().map(|s| 1 + sizeof_len((s).get_size())).sum::<usize>() +
                    1 +
                    sizeof_varint(*(&self.next_commit_position) as u64) + 1 +
                    sizeof_varint(*(&self.next_prepare_position) as u64) +
                    if self.result == mod_ReadAllEventsCompleted::ReadAllResult::Success {
                        0
                    } else {
                        1 + sizeof_varint(*(&self.result) as u64)
                    } +
                    self.error.as_ref().map_or(0, |m| 1 + sizeof_len((m).len()))
                }
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if self.result != mod_ReadAllEventsCompleted::ReadAllResult::Success {
                        w.write_with_tag(48, |w| w.write_enum(*&self.result as i32))?;
                    }
                    if let Some(ref s) = self.error {
                        w.write_with_tag(58, |w| w.write_string(&**s))?;
                    }
            ...
            impl<'a> CreatePersistentSubscription<'a> {
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            Ok(10) => {
                                msg.subscription_group_name = r.read_string(bytes)
                                    .map(Cow::Borrowed)?
                            }
                            Ok(18) => {
                                msg.event_stream_id = r.read_string(bytes).map(Cow::Borrowed)?
                            ...
                            Ok(130) => {
                                msg.named_consumer_strategy = Some(r.read_string(bytes)
                                    .map(Cow::Borrowed)?)
                            }
                            Ok(t) => {
                                r.read_unknown(bytes, t)?;
            ...
            impl<'a> MessageWrite for CreatePersistentSubscription<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.subscription_group_name).len()) + 1 +
                    sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.resolve_link_tos) as u64) + 1 +
                    sizeof_varint(*(&self.start_from) as u64) + 1 +
                    sizeof_varint(*(&self.message_timeout_milliseconds) as u64) +
                    1 + sizeof_varint(*(&self.record_statistics) as u64) + 1 +
                    sizeof_varint(*(&self.live_buffer_size) as u64) + 1 +
                    sizeof_varint(*(&self.read_batch_size) as u64) + 1 +
                    sizeof_varint(*(&self.buffer_size) as u64) + 1 +
                    sizeof_varint(*(&self.max_retry_count) as u64) + 1 +
                    sizeof_varint(*(&self.prefer_round_robin) as u64) + 1 +
                    sizeof_varint(*(&self.checkpoint_after_time) as u64) +
                    1 + sizeof_varint(*(&self.checkpoint_max_count) as u64) +
                    1 +
                    sizeof_varint(*(&self.checkpoint_min_count) as u64) +
                    1 +
                    sizeof_varint(*(&self.subscriber_max_count) as u64) +
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.named_consumer_strategy {
            ...
            impl<'a> MessageWrite for DeletePersistentSubscription<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.subscription_group_name).len()) + 1 +
                    sizeof_len((&self.event_stream_id).len())
                }
    ...
    pub reason: Option<Cow<'a, str>>,
        ...
        + self.reason.as_ref().map_or(0, |m| 1 + sizeof_len((m).len()))
            ...
            impl<'a> ConnectToPersistentSubscription<'a> {
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            Ok(10) => {
                                msg.subscription_id = r.read_string(bytes).map(Cow::Borrowed)?
                            }
                            Ok(18) => {
                                msg.event_stream_id = r.read_string(bytes).map(Cow::Borrowed)?
                            }
            ...
            impl<'a> MessageWrite for ConnectToPersistentSubscription<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.subscription_id).len()) + 1 +
                    sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.allowed_in_flight_messages) as u64)
                }
            ...
            impl<'a> MessageWrite for PersistentSubscriptionAckEvents<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.subscription_id).len()) +
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    w.write_with_tag(10, |w| w.write_string(&**&self.subscription_id))?;
                    for s in &self.processed_event_ids {
            ...
            impl<'a> MessageWrite for PersistentSubscriptionNakEvents<'a> {
                fn get_size(&self) -> usize {
                    ...
                    self.processed_event_ids
                        ...
                        .sum::<usize>() +
                    self.message.as_ref().map_or(0, |m| 1 + sizeof_len((m).len())) +
                    if self.action == mod_PersistentSubscriptionNakEvents::NakAction::Unknown {
                        0
                    } else {
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if self.action != mod_PersistentSubscriptionNakEvents::NakAction::Unknown {
                        w.write_with_tag(32, |w| w.write_enum(*&self.action as i32))?;
                    }
                    Ok(())
                }
            }
            ...
            impl<'a> MessageWrite for PersistentSubscriptionConfirmation<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_varint(*(&self.last_commit_position) as u64) + 1 +
                    sizeof_len((&self.subscription_id).len()) +
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.last_event_number {
            ...
            impl<'a> MessageWrite for SubscribeToStream<'a> {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_len((&self.event_stream_id).len()) + 1 +
                    sizeof_varint(*(&self.resolve_link_tos) as u64)
                }
            ...
            impl MessageWrite for SubscriptionConfirmation {
                fn get_size(&self) -> usize {
                    0 + 1 + sizeof_varint(*(&self.last_commit_position) as u64) +
                    self.last_event_number.as_ref().map_or(0, |m| 1 + sizeof_varint(*(m) as u64))
                }
            ...
            impl<'a> StreamEventAppeared<'a> {
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            Ok(10) => {
                                msg.event = r.read_message(bytes, ResolvedEvent::from_reader)?
                            }
                            Ok(t) => {
                                r.read_unknown(bytes, t)?;
                            }
            ...
            impl MessageWrite for SubscriptionDropped {
                fn get_size(&self) -> usize {
                    0 +
                    if self.reason ==
                       mod_SubscriptionDropped::SubscriptionDropReason::Unsubscribed {
                        0
                    } else {
                        1 + sizeof_varint(*(&self.reason) as u64)
                    }
                }
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    if self.reason !=
                       mod_SubscriptionDropped::SubscriptionDropReason::Unsubscribed {
                        w.write_with_tag(8, |w| w.write_enum(*&self.reason as i32))?;
                    }
                    Ok(())
                }
            }
                ...
                pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                    ...
                    while !r.is_eof() {
                        match r.next_tag(bytes) {
                            ...
                            Ok(18) => {
                                msg.additional_info = Some(r.read_bytes(bytes).map(Cow::Borrowed)?)
                            }
                            Ok(t) => {
                                r.read_unknown(bytes, t)?;
                            }
            ...
            impl<'a> MessageWrite for NotHandled<'a> {
                fn get_size(&self) -> usize {
                    0 + self.reason.as_ref().map_or(0, |m| 1 + sizeof_varint(*(m) as u64)) +
                ...
                fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                    ...
                    if let Some(ref s) = self.additional_info {
                        w.write_with_tag(18, |w| w.write_bytes(&**s))?;
                    }
                    Ok(())
                }
            ...
            pub mod mod_NotHandled {
                ...
                impl<'a> MasterInfo<'a> {
                    pub fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
                        ...
                        while !r.is_eof() {
                            match r.next_tag(bytes) {
                                Ok(10) => {
                                    msg.external_tcp_address = r.read_string(bytes)
                                        .map(Cow::Borrowed)?
                                }
                                Ok(16) => msg.external_tcp_port = r.read_int32(bytes)?,
                                Ok(26) => {
                                    msg.external_http_address = r.read_string(bytes)
                                        .map(Cow::Borrowed)?
                                }
                                Ok(32) => msg.external_http_port = r.read_int32(bytes)?,
                                Ok(42) => {
                                    msg.external_secure_tcp_address = Some(r.read_string(bytes)
                                        .map(Cow::Borrowed)?)
                                }
                ...
                impl<'a> MessageWrite for MasterInfo<'a> {
                    fn get_size(&self) -> usize {
                        0 + 1 + sizeof_len((&self.external_tcp_address).len()) + 1 +
                        sizeof_varint(*(&self.external_tcp_port) as u64) +
                        1 +
                        sizeof_len((&self.external_http_address).len()) +
                        1 +
                        sizeof_varint(*(&self.external_http_port) as u64) +
                    ...
                    fn write_message<W: Write>(&self, w: &mut Writer<W>) -> Result<()> {
                        ...
                        if let Some(ref s) = self.external_secure_tcp_address {
                            w.write_with_tag(42, |w| w.write_string(&**s))?;
                        }
                        if let Some(ref s) = self.external_secure_tcp_port {
                            w.write_with_tag(48, |w| w.write_int32(*s))?;
                        }
                        Ok(())
                    }
                }
            ...
            impl<'a> MessageWrite for ScavengeDatabaseCompleted<'a> {
                fn get_size(&self) -> usize {
                    0 + self.result.as_ref().map_or(0, |m| 1 + sizeof_varint(*(m) as u64)) +
                    self.error.as_ref().map_or(0, |m| 1 + sizeof_len((m).len())) +
                    1 + sizeof_varint(*(&self.total_time_ms) as u64) + 1 +
                    sizeof_varint(*(&self.total_space_saved) as u64)
                }
